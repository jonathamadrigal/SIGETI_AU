...
public class PanelTicketsDelArea extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbTerminados = new javax.swing.JLabel();
        lbNuevos = new javax.swing.JLabel();
        ...
        jLabelTitulo.setText("Tickets del área");
        ...
        jLabel12.setText("Seleccione el ticket que desea ver / cerrar ");
        ...
        tablaTickets.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Número de ticket", "Creado por", "Encargado", "Estado"
            }
        ) {
        ...
        jLabel2.setText("Tickets asignados");

        jLabel4.setText("Tickets en proceso ");

        jLabel6.setText("Tickets  terminados");

        jLabel8.setText("Total de tickets");

        jLabel10.setText("Tiickets sin ver");

        lbAsignados.setForeground(new java.awt.Color(255, 0, 0));

        lbProceso.setForeground(new java.awt.Color(255, 0, 0));

        lbTerminados.setForeground(new java.awt.Color(255, 0, 0));

        lbNuevos.setForeground(new java.awt.Color(255, 0, 0));
        ...
        jPanelCantidadLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelCantidadLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lbTerminados)
                .addGap(28, 28, 28)
                .addComponent(jLabel10)
                .addGap(18, 18, 18)
                .addComponent(lbNuevos)
                .addGap(27, 27, 27)
...
//                    PanelBandejaArea.obtenerInstancia().llenarBandeja();
    ...
    private void LlenaTicketsDelArea() {
        ...
        this.lbNuevos.setText(String.valueOf(Controlador.obtenerInstancia().cantidadNuevosArea(VentanaLogin.correo)));
        this.lbProceso.setText(String.valueOf(Controlador.obtenerInstancia().cantidadProcesoArea(VentanaLogin.correo)));
        this.lbTerminados.setText(String.valueOf(Controlador.obtenerInstancia().cantidadCerradosArea(VentanaLogin.correo)));
        this.lbTotal.setText(String.valueOf(Controlador.obtenerInstancia().cantidadTotalArea(VentanaLogin.correo)));

        modelAux = (DefaultTableModel) tablaTickets.getModel();
        while (modelAux.getRowCount() > 0) {
            modelAux.removeRow(0);
        }
        ArrayList<Ticket> aux = Controlador.obtenerInstancia().ticketsDelArea(VentanaLogin.correo);
        if (aux.isEmpty()) {
        } else {
            int i = 0;
            while (i < aux.size()) {
                modelAux.insertRow(modelAux.getRowCount(), new Object[]{aux.get(i).getConsecutivo(),
                    aux.get(i).getCorreoUsuario(), aux.get(i).getResponsable(), this.obtieneEstado(aux.get(i))});
                i++;
            }
            
            Controlador.obtenerInstancia().ejecutarSentenciaSQL(Controlador.obtenerInstancia().consultarConsecutivoBitacora(),
                    VentanaLogin.correo, "Ticket", "Consultó tickets del área");
            
        }
        tablaTickets.revalidate();
        tablaTickets.repaint();
        this.lbTotal.setText(String.valueOf(modelAux.getRowCount()));
...
//Declaracion de variables
    ...
    private javax.swing.JLabel lbNuevos;
    private javax.swing.JLabel lbProceso;
    private javax.swing.JLabel lbTerminados;
